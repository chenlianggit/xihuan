...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 快递管理 <span class="c-gray en">&gt;</span> 全部快递 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            <th width="40">ID</th>
            <th width="150">快递名称</th>
            <th width="130">价格</th>
            <th width="80">快递100对应代码</th>
            <th width="100">操作</th>
        </tr>
        </thead>
