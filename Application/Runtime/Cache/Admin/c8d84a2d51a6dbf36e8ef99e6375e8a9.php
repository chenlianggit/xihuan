...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 活动管理 <span class="c-gray en">&gt;</span> 全部活动 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        ...
        <?php if(is_array($adv_list)): $i = 0; $__LIST__ = $adv_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adv): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td>
                    <?php if($adv["position"] == 1): ?><span class="label succ">首页头部轮播</span>
                        <?php else: ?>
                        <span class="label err">首页活动</span><?php endif; ?>
                </td>
                <td class="obj_1">
                    <a href="<?php echo U('add');?>?adv_id=<?php echo ($adv["id"]); ?>" >修改</a>&nbsp;|
                    <a href="<?php echo U('add_product');?>?adv_id=<?php echo ($adv["id"]); ?>" >增加活动商品</a>&nbsp;|
