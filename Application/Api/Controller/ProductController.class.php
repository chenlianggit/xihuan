...
class ProductController extends PublicController {
	...
	public function index(){
		...
		$rmb_area = preg_split("/#/",$rmb_ratio['sval']);
		...
		$pro['coupon_money'] = sprintf("%.2f",$pro['price_yh'] * ($pro['integral'] / 100));

		$jisuan = $pro['price_yh'] * ($pro['integral'] / 100) * $rmb_area[1];

		$pro['integral_buy'] = intval($jisuan);
