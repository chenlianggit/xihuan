...
class LoginController extends PublicController {
	...
	public function authlogin(){
		...
		if ($uid) {
			...
			if ( !empty($_POST['NickName']) && $_POST['NickName'] != 'undefined') {
				$result=M("user")->where("openid='{$openid}'")->save(['name'=>$_POST['NickName'],'uname'=>$_POST['NickName'],'photo'=>$_POST['HeadUrl'],'sex'=>$_POST['gender']]);
			}
	...
	public function getsessionkeys(){
    	...
    	$secret = 'e6937f1623c387c25be9906aa2072ba2';
